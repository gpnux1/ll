...
// @ 0x0802698C
/* 战斗对象"多段闪光/抖动演出"状态机 (gUnk_03000820: 0 → 3 → 4 → 2 → 1 ⇄ 5 → 6 → 7 → 9)。
 ...
 *   case6  gUnk_03000858 非 0 → 9 否则 → 7。
 *   case7  headA 的 0x1000 落 → 清位 + sub_801CE80 复位 → 9。
 *   case9  无其他演出占用时对 0x03000840[] 中 (v&0xF0)==0x10 项按 Rng%100<=0x27 置 gUnk_03004F90; 返回 1。
    ...
    switch (gUnk_03000820)
    {
        ...
        case 2:
        {
            ...
            sub_801B81C(&obj->headB, 0x80, 0x77, 0x2EA, 0xE,
                        gUnk_08393B28[0xDC5], gUnk_08393B28[0xDC6],
                        ((u16 *)gUnk_08393B28)[0x1B8E], ((u16 *)gUnk_08393B28)[0x1B8F], 4);
            obj->state |= 0x2000;
            obj->headB.f_2A = 2;
            gUnk_03000825 = 0;
            gUnk_03000820 = 1;
        ...
        case 1:
            ...
            gUnk_03000825 += 1;
            if (gUnk_03000825 == 0x10)
            {
                obj->headA.kindFlags &= 0xFEFF;
                break;
            }
            if (gUnk_03000825 <= 0x17)
                break;
            {
                extern u32 gUnk_08393B28[];
                obj->headB.kindFlags &= 0xEFFF;
                sub_801B81C(&obj->headB, 0x74, 0x80, 0x2EA, 0xE,
                            gUnk_08393B28[0xDCA], gUnk_08393B28[0xDCB],
                            ((u16 *)gUnk_08393B28)[0x1B98], ((u16 *)gUnk_08393B28)[0x1B99], 4);
        ...
        case 7:
            ...
            sub_801CE80(obj, 0, gUnk_03000822, gUnk_03000824, 0);
            gUnk_03000820 = 9;
            break;
        case 9:
...
// @ 0x08026D08
/* 战斗对象"开场闪光/亮场过渡"演出状态机 (gUnk_03000820: 0 起手 → 3 等 headB 落地 →
    ...
    switch (gUnk_03000820)
    {
        case 0:
            ...
            sub_801B81C(&obj->headB, 0xA, 0x13, 0, 0xE,
                        gUnk_08393B28[0xDE8], gUnk_08393B28[0xDE9],
                        ((u16 *)gUnk_08393B28)[0x1BD4], ((u16 *)gUnk_08393B28)[0x1BD5], 6);
            obj->state |= 0x2000;
            obj->headB.f_2A = 0;
            gUnk_03000825 = 0;
            gUnk_03000820 = 3;
        ...
        case 5:
            if (gUnk_03000825 <= 4)
            {
                *(volatile u16 *)0x04000052 = sub_801768C(3, 0xC, 5, gUnk_03000825, 2) + 0xC00;
                gUnk_03000825 += 1;
            }
            else
            {
        ...
        case 1:
            if (obj->headA.kindFlags & 0x1000)
            {
                ...
                if (gUnk_03000825 <= 0xE)
                {
                    *(volatile u16 *)0x04000052 = sub_801768C(0xF, -0xC, 0xF, gUnk_03000825, 1) + 0xC00;
                    gUnk_03000825 += 1;
                }
            }
            if (obj->headB.kindFlags & 0x1000)
...
// @ 0x08026F88
/* 战斗对象"召唤伙伴+抖动演出"状态机 (gUnk_03000820: 0 → 0x12..0x18 → 9)。
 ...
 *          gUnk_03000867=0; sub_801A2AC(0x442, 0, 0xC) → 0x14。
 *   0x14   headA.frameIdx <= 0x82 时用 sub_801768C(0,7,0x14, frameIdx-0x6F, 2) 更新
 *          gUnk_03000867 并 sub_801A2AC(0x442, gUnk_03000867, 0xC); 否则 → 0x15。
...
u8 sub_8026F88(BattleObj *obj, BattleObj *arg1)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 20:
            ...
            {
                gUnk_03000867 = sub_801768C(0, 7, 0x14, (s16)(obj->headA.frameIdx - 0x6F), 2);
        ...
        case 21:
            ...
            {
                gUnk_03000867 = sub_801768C(7, -7, 0x13, (s16)(obj->headA.frameIdx - 0x83), 2);
                sub_801A2AC(0x442, gUnk_03000867, 0xC);
            }
            else
            {
                ...
                *(volatile u16 *)0x04000000 &= 0xFDFF;
                sub_801A2AC(0, gUnk_03000867, 0xC);
                sub_8044514(0x2D);
                gUnk_03000825 = 0;
                gUnk_03000820 = 0x16;
            }
...
// @ 0x0802723C
/* 战斗对象"召唤/技能释放"长演出状态机 (gUnk_03000820: 0 → 0x12..0x1E → 9)。
 ...
 *          gUnk_03000867=0; sub_801A2AC(0x442,0,0xC) → 0x14。
 *   0x14   frameIdx<=0x82 → gUnk_03000867 = sub_801768C(0,7,0x14,frameIdx-0x6F,2) +
...
u8 sub_802723C(BattleObj *obj)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 25:
            ...
            break;
        case 26:
            if (gUnk_03000825 <= 0x1D)
            {
                gUnk_03000867 = sub_801768C(9, -9, 0x1E, gUnk_03000825, 2);
                sub_801A2AC(0x1447, gUnk_03000867, 0xF);
                gUnk_03000825 += 1;
            }
            else
            {
...
// @ 0x0802761C
/* 战斗对象"特效/背景覆盖"演出状态机 (gUnk_03000820: 0 起手 → 1..7 等待 → 8 收尾 → 9 全体效果)。
 ...
 * case9 在无其他演出占用时给 0x03000840 里 (v&0xF0)==0x10 的条目按 40% 置 gUnk_03004F90。
...
// @ 0x08027760
/* 战斗对象"换位靠近"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x19 → 9)。
 ...
 *   9      返回 1。
 * 尾部: gUnk_03000825 += 1; sub_803F658(obj)。无 sub_80187E8, 无尾部 kindFlags 收尾。 */
u8 sub_8027760(BattleObj *obj, BattleObj *obj2)
{
    ...
    switch (gUnk_03000820)
    {
        case 0:
            ...
            break;
        case 18:
            if (gUnk_03000825 <= 0x31)
            {
                obj->posX = sub_801768C(gUnk_03000828, (obj2->posX - 0x96) - gUnk_03000828, 0x32, gUnk_03000825, 2);
                obj->posY = sub_801768C(gUnk_03000829, (obj2->posY + 0xF) - gUnk_03000829, 0x32, gUnk_03000825, 2);
            }
            else
            {
                Sfx_StopTrack(1);
        ...
        case 24:
            if (gUnk_03000844 == 0 && gUnk_03000845 == 0 && gUnk_03000856 == 0)
            {
                sub_801CE80(obj, 0, gUnk_03000822, gUnk_03000824, 0);
                obj->headA.kindFlags |= 0x100;
                obj->posX = gUnk_03000828;
                obj->posY = gUnk_03000829;
                gUnk_03000820 = 0x19;
            }
            break;
        case 25:
...
// @ 0x08027A20
/* 战斗对象"前冲/回位"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x18 两段位移 → 0x19 收尾 → 9 全体效果)。
 * 与 sub_802761C/sub_802F480 同族 (同样在尾部 sub_803F658 + 帧计数 gUnk_03000825 += 1)。
 ...
 * (本对象前后半步), 随后 0x14..0x18 用 sub_801768C 逐帧插值 posY (gUnk_03000829 为基准)
 * 或按 gUnk_03000828 偏移写 posX, 完成一趟出去再回来; 收尾 0x19 清 0x1000 并把暂存的
...
u8 sub_8027A20(BattleObj *obj)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 19:
            ...
            break;
        case 20:
            if (gUnk_03000825 == 0xD)
                obj->headA.kindFlags |= 0x200;
            if (gUnk_03000825 <= 0x13)
            {
                obj->posY = sub_801768C(gUnk_03000829, -0x64, 0x14, gUnk_03000825, 2);
            }
            else
            {
                obj->posX = 0xB4;
        ...
        case 21:
            ...
            if (gUnk_03000825 <= 0x13)
            {
                obj->posY = sub_801768C(gUnk_03000829 - 0x64, 0x64, 0x14, gUnk_03000825, 1);
            }
            else
            {
                gUnk_03000825 = 0;
...
// @ 0x08027D9C
/* 战斗对象"绕行到伙伴身边"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x18 → 9)。
...
u32 sub_8027D9C(BattleObj *obj, BattleObj *arg1)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 21:
            if (gUnk_03000825 <= 9)
            {
                obj->headB.f_2B = sub_801768C(obj->posX + 0xA, arg1->posX - (obj->posX + 0xA), 0xA, gUnk_03000825, 2);
                obj->headB.f_2C = sub_801768C(obj->posY - 0x14, (arg1->posY + 0xC) - obj->posY, 0xA, gUnk_03000825, 2);
            }
            else
            {
                gUnk_03000825 = 0;
        ...
        case 22:
            if (gUnk_03000825 <= 9)
            {
                obj->headB.f_2B = sub_801768C(arg1->posX, (obj->posX + 0xA) - arg1->posX, 0xA, gUnk_03000825, 1);
                obj->headB.f_2C = sub_801768C(arg1->posY - 8, (obj->posY - 0xC) - arg1->posY, 0xA, gUnk_03000825, 1);
            }
            else
            {
                gUnk_03000825 = 0;
...
// @ 0x08028098
/* 战斗对象"前冲/后撤"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x16 → 9 全体效果)。
    ...
    switch (gUnk_03000820)
    {
        ...
        case 22:
            if (obj->headB.frameIdx == 0x2C)
                Sfx_Play(0x5A, 1, 0);
            gUnk_03000825 += 1;
            if (gUnk_03000825 == 0x6E)
                sub_8044514(0x37);
            else if (gUnk_03000825 == 0x73)
                gUnk_03000820 = 9;
            break;
        case 9:
            if (gUnk_03000844 == 0 && gUnk_03000845 == 0 && gUnk_03000856 == 0)
...
// @ 0x080282EC
/* 战斗对象"伙伴换位/支援"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x19 → 9)。
...
u8 sub_80282EC(BattleObj *obj, BattleObj *arg1)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 19:
            if (gUnk_03000825 <= 9)
            {
                obj->posY = sub_801768C(gUnk_03000829, (arg1->posY + 0x10) - gUnk_03000829, 0xA, gUnk_03000825, 2);
                gUnk_03000825 += 1;
            }
            else
            {
        ...
        case 24:
        {
            ...
            sub_801CE80(obj, 0, gUnk_03000822, gUnk_03000824, f);
            obj->posX -= 0x47;
            gUnk_03000820 = 0x19;
            gUnk_03000825 = 0;
            break;
        ...
        case 25:
            ...
            if (gUnk_03000825 <= 9)
            {
                obj->posY = sub_801768C(arg1->posY + 0x10, gUnk_03000829 - (arg1->posY + 0x10), 0xA, gUnk_03000825, 2);
                gUnk_03000825 += 1;
            }
            else
            {
...
// @ 0x080285A0
/* 战斗对象"归位/后撤到目标"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x17 → 9)。
...
u8 sub_80285A0(BattleObj *obj, BattleObj *obj2)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 19:
            ...
            {
                obj->posX = sub_801768C(gUnk_03000828, (obj2->posX - 0x30) - gUnk_03000828, 0x2F, (s16)obj->headA.frameIdx, 2);
                obj->posY = sub_801768C(gUnk_03000829, obj2->posY - gUnk_03000829, 0x2F, (s16)obj->headA.frameIdx, 2);
            }
            else
            {
                gUnk_03000820 = 0x14;
...
// @ 0x080287EC
/* 战斗对象"双段归位/重摆位"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x19 → 9)。
...
// @ 0x08029268
/* 战斗对象"登场/移动到目标"演出状态机 (gUnk_03000820: 0 起手 → 1..9)。
...
u8 sub_8029268(BattleObj *obj, BattleObj *arg1)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 7:
            if (obj->headA.kindFlags & 0x1000)
            {
                sub_80207DC(obj, gUnk_03000828, gUnk_03000829, gUnk_03000822, gUnk_03000824);
                gUnk_03000820 = 9;
            }
            break;
        case 9:
...
// @ 0x08029510
/* 战斗对象"强化/特效"演出状态机 (gUnk_03000820: 0 起手 → 1..9)。
...
// @ 0x08029784
/* 战斗对象"强化/特效"演出状态机 (变体; gUnk_03000820: 0 起手 → 1..9)。
...
// @ 0x080299C8
/* 战斗对象"归位到目标"演出状态机 (双参; gUnk_03000820: 0 起手 → 1..6 → 9)。
 ...
 *   case6  无其他演出占用 (gUnk_03000844/45/56 全 0) → 9。
 *   9      返回 1。
 * 尾部: gUnk_03000825 += 1; sub_803F658(obj)。 (无 sub_80187E8) */
u8 sub_80299C8(BattleObj *obj, BattleObj *arg1)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 2:
            if (obj->headA.frameIdx <= 0x2E)
            {
                obj->posX = sub_801768C(gUnk_03000828, (arg1->posX - 0x30) - gUnk_03000828, 0x2F, (s16)obj->headA.frameIdx, 2);
                obj->posY = sub_801768C(gUnk_03000829, arg1->posY - gUnk_03000829, 0x2F, (s16)obj->headA.frameIdx, 2);
            }
            else
            {
                gUnk_03000820 = 3;
...
u8 sub_8029BF8(BattleObj *obj)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 18:
            if (gUnk_03000825 <= 9)
            {
                gUnk_03000867 = sub_801768C(0x10, -0x10, 0xA, gUnk_03000825, 2);
                sub_801A2AC(0x410, gUnk_03000867, (u8)(0x10 - gUnk_03000867));
                gUnk_03000825 += 1;
                break;
            }
            obj->headA.kindFlags |= 0x200;
        ...
        case 21:
            if (gUnk_03000825 <= 0x13)
            {
                ...
                gUnk_03000867 = sub_801768C(0, 0x10, 0x14, gUnk_03000825, 2);
                sub_801A2AC(0x1747, gUnk_03000867, 0x10);
                gUnk_03000825 += 1;
                break;
            }
            gUnk_03000825 = 0;
        ...
        case 22:
            if (gUnk_03000825 <= 9)
            {
                gUnk_03000868 = sub_801768C(0x10, -0x10, 0xA, gUnk_03000825, 2);
                sub_801A2AC(0x1747, gUnk_03000867, gUnk_03000868);
                gUnk_03000825 += 1;
                break;
            }
            gUnk_03000825 = 0;
        ...
        case 32:
            if (gUnk_03000825 <= 0x1F)
            {
                gUnk_03000867 = sub_801768C(0, 0x10, 0x20, gUnk_03000825, 2);
                sub_801A2AC(0x410, gUnk_03000867, (u8)(0x10 - gUnk_03000867));
                gUnk_03000825 += 1;
                break;
            }
...
// @ 0x0802A154
/* 战斗对象"文字框/换装长演出"状态机 (gUnk_03000820: 0 起手 → 0x12..0x21 → 0x23/0x24 → 9)。
 * 单参; 唯一入口 0x0839CD5C 指针表 idx 0x1A (thumb 0x0802A155)。
 * 用 headA 主头 + sub_801A2AC 文字框/图层 + sub_801768C 插值 gUnk_03000867/68 双窗口,
    ...
    switch (gUnk_03000820)
    {
        ...
        case 28:
            if (gUnk_03000825 <= 9)
            {
                ...
                sub_801A2AC(0x1747, (u8)(0x10 - gUnk_03000868), gUnk_03000868);
                gUnk_03000825 += 1;
            }
            else
            {
        ...
        case 36:
            ...
            else if (gUnk_03000844 == 0 && gUnk_03000845 == 0 && gUnk_03000856 == 0)
            {
                gUnk_03000820 = 9;
            }
            break;
...
// @ 0x0802A86C
/* 战斗对象"长演出/换装"状态机 (gUnk_03000820: 0 → 0x12..0x21 → 9)。
 ...
 * 用 gUnk_03000867/03000868 双窗口插值 + sub_801A348/sub_801A3A8/sub_801A2AC 文字框 +
...
// @ 0x0802ADC4
/* 战斗对象"召唤/贝斯手演出"状态机 (gUnk_03000820: 0 起手 → 0x12..0x19 → 9)。
 ...
 * gUnk_03000867 窗口插值), 但中段换用 sub_804B96C/sub_804C4D8 做调色板/装备层切换。
 *   case0   记 posX/posY/headA.f_1E/palSlot, 计数=0 → 0x12。
 *   0x12    headA 的 0x800 落 → 清 headA 0x100 + sub_801A348 → 0x13。
 *   0x13    sub_8019B98(0xE,3,0xE,1) != 0 → Sfx(0x5A) + gUnk_03000867=0 +
 ...
 *           sub_801A2AC(0x1C42,gUnk_03000867,0x10) + 计数++; 超过: 计数=0,
 *           gUnk_03000867=0xC + sub_801A2AC(0x1C42,0xC,0x10) → 0x16。
...
// @ 0x0802B0F0
/* 战斗对象双参"绕行归位/两段位移"演出状态机 (gUnk_03000820: 0 → 0x12..0x1E → 9)。
...
u8 sub_802B0F0(BattleObj *obj, BattleObj *arg1)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 22:
            if (gUnk_03000825 <= 0x1D)
            {
                obj->posX = sub_801768C(gUnk_03000828, arg1->posX - 8 - gUnk_03000828, 0x1E, gUnk_03000825, 0);
                obj->posY = sub_801768C(gUnk_03000829, arg1->posY - gUnk_03000829, 0x1E, gUnk_03000825, 0);
                obj->pad_C1 = sub_801768C(0, 0x46, 0xF, gUnk_03000825, 2);
                gUnk_03000825 += 1;
            }
            else
            {
        ...
        case 27:
            ...
            obj->headA.kindFlags |= 0x100;
            gUnk_03000825 = 0;
            gUnk_0300086E = obj->posX;
            gUnk_0300086F = obj->posY;
            gUnk_03000820 = 0x1C;
            Sfx_Play(0x31, 1, 0);
            break;
        case 28:
            if (gUnk_03000825 <= 0x1D)
            {
                obj->posX = sub_801768C(gUnk_0300086E, gUnk_03000828 - gUnk_0300086E, 0x1E, gUnk_03000825, 0);
                obj->posY = sub_801768C(gUnk_0300086F, gUnk_03000829 - gUnk_0300086F, 0x1E, gUnk_03000825, 0);
                obj->pad_C1 = sub_801768C(0, 0x46, 0xF, gUnk_03000825, 2);
                gUnk_03000825 += 1;
            }
            else
...
// @ 0x0802B608
/* 战斗对象"召唤/技能释放"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x18 → 9)。
 ...
 *   0x16   帧计数 <= 0x1D 时 gUnk_03000867 = sub_801768C(9,-9,0x1E,cnt,2) +
 *          sub_801A2AC(0x1447,gUnk_03000867,0xF); 超过则 Sfx_StopTrack(1) + sub_804BE90(0xE,1) +
...
// @ 0x0802B8BC
/* 战斗对象"闪现/瞬移演出"状态机 (gUnk_03000820: 0 起手 → 0x12..0x17 → 9)。
...
// @ 0x0802BB24
/* 战斗对象"召唤伙伴/传送"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x17 → 9)。
...
// @ 0x0802BD94
/* 战斗对象"蓄力/多段演出"状态机 (gUnk_03000820: 0 起手 → 0x12..0x1B → 9)。
...
// @ 0x0802C0EC
/* 战斗对象"变身/强化+位移"演出状态机 (单参; gUnk_03000820: 0 起手 → 0x12..0x19 → 9)。
 ...
 *           posX = sub_801768C(gUnk_0300086E, 0xF0-gUnk_0300086E, 0x32, 计数, 2); 计数++;
 *           超过: 计数=0, pad_C1=posY, posX=暂存 gUnk_03000828, state&=0xDFFF,
 *           sub_8044514(0x28) → 0x18。
 *   0x18    计数<=0x27: gUnk_03000867=sub_801768C(0xF,-0xF,0x28,计数,2),
 *           gUnk_03000868=sub_801768C(8,8,0x28,计数,2), sub_801A2AC(0x1F47,67,68); 计数++;
...
//                 break;
//             Sfx_StopTrack(1);
//             sub_801CE80(obj, 0, gUnk_03000822, zero, 0);
//             gUnk_03000820 = 0x14;
//             break;
//         case 20:
//             if (obj->headA.kindFlags & 0x800)
...
//                 obj->posX = sub_801768C(gUnk_0300086E, 0xF0 - gUnk_0300086E, 0x32, gUnk_03000825, 2);
//                 gUnk_03000825 += 1;
//             }
//             else
//             {
...
//             {
//                 gUnk_03000867 = sub_801768C(0xF, -0xF, 0x28, gUnk_03000825, 2);
//                 gUnk_03000868 = sub_801768C(8, 8, 0x28, gUnk_03000825, 2);
//                 sub_801A2AC(0x1F47, gUnk_03000867, gUnk_03000868);
//                 gUnk_03000825 += 1;
//             }
//             else
//             {
...
// }
// @ 0x0802C490
/* 战斗对象"多段演出/蓄力"状态机 (单参; gUnk_03000820: 0 起手 → 0x12..0x18 → 9)。
 ...
 *           随后帧计数 += 1 (本 case 恒递增)。
 *   9       无其他演出占用 (gUnk_03000844/45/56 全 0) → result=1; 否则帧计数 += 1。
 * 尾部 sub_803F658(obj)。注意只有 case0x18 与 case9 的等待分支会递增 gUnk_03000825。 */
...
// @ 0x0802C714
/* 战斗对象"多段演出/蓄力"状态机 (gUnk_03000820: 0 起手 → 0x12..0x19 → 9)。
 ...
 *   9      无其他演出占用 (gUnk_03000844/45/56 全 0) → result=1。
 * 尾部 sub_803F658(obj)。 */
...
// @ 0x0802C9E8
/* 战斗对象"多段演出/绕到目标+位移"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x1B → 0x17 → 9)。
 ...
 *           并把 headB.f_2B/f_2C 从 gUnk_0300086E/F 向 arg1 的 (posX, posY+4) 插值;
...
u8 sub_802C9E8(BattleObj *obj, BattleObj *arg1)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 22:
            if (obj->headA.kindFlags & 0x1000)
                obj->headA.kindFlags = (obj->headA.kindFlags & 0xEFFF) | 0x100;
            gUnk_0300086E = obj->posX + 0x2E;
            gUnk_0300086F = obj->posY - 0x2E;
            sub_8020CC4(obj, gUnk_0300086E, gUnk_0300086F, 0x27C, 0xC, 0x31A, 5);
            gUnk_03000820 = 0x17;
            break;
        case 23:
            if (obj->headA.kindFlags & 0x1000)
        ...
        case 24:
            ...
            if (gUnk_03000825 <= 9)
            {
                ...
                obj->headB.f_2B = sub_801768C(gUnk_0300086E, arg1->posX - gUnk_0300086E, 0xA, gUnk_03000825, 0);
                obj->headB.f_2C = sub_801768C(gUnk_0300086F, (arg1->posY + 4) - gUnk_0300086F, 0xA, gUnk_03000825, 0);
                gUnk_03000825 += 1;
            }
            else
            {
...
// @ 0x0802CE90
/* 战斗对象"冲刺/跳跃攻击"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x1A → 9)。
 ...
 *   0x1A   计数<=0x18: 计数++ + gUnk_03000867 = sub_801768C(7,-7,0x19,计数,2) +
 *          sub_801A2AC(0x1C47,gUnk_03000867,0xF); 否则 sub_804BE90(0xE,1) +
...
u8 sub_802CE90(BattleObj *obj)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 25:
            ...
            break;
        case 26:
            if (gUnk_03000825 <= 0x18)
            {
                gUnk_03000825 += 1;
                gUnk_03000867 = sub_801768C(7, -7, 0x19, gUnk_03000825, 2);
                sub_801A2AC(0x1C47, gUnk_03000867, 0xF);
                break;
            }
            sub_804BE90(0xE, 1);
            sub_801A2AC(0, 0, 0);
...
// @ 0x0802D1FC
/* 战斗对象"放声/蓄力"演出状态机 (gUnk_03000820: 0 → 0x12..0x17 → 9)。
...
// @ 0x0802D454
/* 战斗对象"蓄力/放声"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x19 → 9)。
 ...
 *   0x17   无其他演出占用 (gUnk_03000844/45/56 全 0) → headA.kindFlags &= 0xFEFF → 0x18。
 *   0x18   headA.kindFlags 到 0x1000 → sub_801CE80 复位 → 0x19。
 *   0x19   等 headA.kindFlags 的 0x800 落 → 9。
 *   9     遍历 gUnk_03000840 命中槽 (高半字节==0x10) 按 40/100 概率写
 *          gUnk_03004F90[低半字节]=2, 返回 1。
 * 尾部 sub_803F658(obj)。 */
        ...
        case 9:
        {
            ...
            for (i = 0; i < gUnk_0300083D; i++)
            {
                if ((gUnk_03000840[i] & 0xF0) != 0x10)
                    continue;
                if (((u32 (*)(void))Rng_LcgNext)() % 0x64 <= 0x27)
                    gUnk_03004F90[gUnk_03000840[i] & 0xF] = 2;
            }
            result = 1;
            break;
        }
...
// @ 0x0802D728
/* 战斗对象双参"目标重定位/多段插值"演出状态机 (gUnk_03000820: 0 → 0x12..0x17 → 9)。
    ...
    switch (gUnk_03000820)
    {
        ...
        case 19:
            ...
            if (obj->headA.frameIdx <= 0x79)
                break;
            Sfx_Play(0x31, 1, 0);
            gUnk_0300086E = (u8)(obj->posX + 0x1D);
            gUnk_0300086F = (u8)(obj->posY - 0x2F);
            sub_8020CC4(obj, gUnk_0300086E, gUnk_0300086F, 0x27C, 0xE, 0x328, 5);
            obj->headB.kindFlags |= 0x100;
            gUnk_03000820 = 0x14;
            break;
        case 20:
        ...
        case 21:
            ...
            if (gUnk_03000825 <= 9)
            {
                ...
                obj->headB.f_2B = sub_801768C(gUnk_0300086E, obj2->posX - gUnk_0300086E, 0x1E, gUnk_03000825, 0);
                obj->headB.f_2C = sub_801768C(gUnk_0300086F, obj2->posY - gUnk_0300086F, 0x1E, gUnk_03000825, 0);
                gUnk_03000825 += 1;
            }
            else
            {
...
// @ 0x0802DA78
/* 战斗对象"多段连击/旋转攻击"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x1A → 9)。
 * 同 sub_802CE90 族单参, 但用 headA.frameIdx 的 %0x1F 循环驱动两段 sub_8020CC4。
 *   case0  记 posX/posY/headA.f_1E/palSlot, sub_80444A4 +
 *          sub_801CE80(obj,5,gUnk_03000822,0xD,0) + sub_803F5B4; 计数=0xA, f_B6=1, f_B4=0 → 0x12。
 *   0x12   等 headA.kindFlags 的 0x800 落 → 0x13。
...
u8 sub_802DA78(BattleObj *obj)
{
    ...
    switch (gUnk_03000820)
    {
        case 0:
            ...
            gUnk_03000824 = obj->headA.palSlot;
            sub_80444A4(obj);
            sub_801CE80(obj, 5, gUnk_03000822, 0xD, 0);
            sub_803F5B4(obj);
            gUnk_03000825 = 0xA;
            obj->f_B6 = 1;
            obj->f_B4 = 0;
...
u32 sub_802DFDC(BattleObj *arg)
{
    ...
    {
        case 0:
            gUnk_03000828 = arg->posX;
            gUnk_03000829 = arg->posY;
...
// @ 0x0802E234
/* 战斗对象"横移演出"状态机 (gUnk_03000820: 0 起手 → 0x12..0x17 → 9)。
 * 单参; 唯一入口 0x0839CE04 指针表 handler。用 headA 主头动画, 中段把 posX 从暂存
 * gUnk_03000828 插值到 0xF0 (向右横移), 末尾复位。
 *   case0   记 posX/posY/headA.f_1E/palSlot, 计数=0, sub_80444A4 清同组伤害 +
 ...
 *           +0x4D; posX = sub_801768C(gUnk_03000828, 0xF0-g8628, 0x14, 计数, 2); 计数++;
...
u8 sub_802E234(BattleObj *obj)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 21:
            if (gUnk_03000825 <= 0x13)
            {
                if (gUnk_03000825 == 0xA)
                    sub_8044514(0x14);
                obj->headA.frameIdx = (obj->headA.frameIdx + 1) % 0x15 + 0x4D;
                obj->posX = sub_801768C(gUnk_03000828, 0xF0 - gUnk_03000828, 0x14, gUnk_03000825, 2);
                gUnk_03000825 += 1;
            }
            else
            {
...
// @ 0x0802E6C8
/* 战斗对象"多段演出/蓄力"状态机 (gUnk_03000820: 0 起手 → 0x1C..0x1F → 0x15..0x1B → 9)。
...
// @ 0x0802F6D8
/* 战斗对象"换装/形态切换"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x19 → 9)。
...
u8 sub_802F6D8(BattleObj *obj)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 21:
            if (gUnk_03000825 <= 0xF)
            {
                obj->posX = sub_801768C(gUnk_03000828, 0xF0 - gUnk_03000828, 0x10, gUnk_03000825, 2);
                gUnk_03000825 += 1;
            }
            else
            {
        ...
        case 25:
            if (gUnk_03000825 <= 0x1D)
            {
                obj->pad_C1 = sub_801768C(obj->posY, -obj->posY, 0x1E, gUnk_03000825, 2);
                gUnk_03000825 += 1;
            }
            else
            {
...
u8 sub_802F9EC(BattleObj *obj)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 19:
            if (gUnk_03000825 <= 9)
            {
                obj->posX = sub_801768C(gUnk_03000828, 0x1E - gUnk_03000828, 0xA, gUnk_03000825, 2);
                gUnk_03000825 += 1;
                break;
            }
            gUnk_03000825 = 0;
        ...
        case 20:
            ...
            {
                obj->headA.frameIdx = (obj->headA.frameIdx + 1) % sub_801B95C(&obj->headA) + 0x14;
                obj->posX = sub_801768C(gUnk_0300086E, 0xF0 - gUnk_0300086E, 0x14, gUnk_03000825, 2);
                gUnk_03000825 += 1;
                break;
            }
            gUnk_03000825 = 0;
        ...
        case 25:
            ...
            {
                obj->headB.frameIdx = (obj->headB.frameIdx + 1) % 0xD + 0x1C;
                gUnk_03000867 = sub_801768C(0xA, -0xA, 0xA, gUnk_03000825, 2);
                gUnk_03000868 = sub_801768C(0xC, 4, 0xA, gUnk_03000825, 2);
                sub_801A2AC(0x1F47, gUnk_03000867, gUnk_03000868);
                gUnk_03000825 += 1;
                break;
            }
...
u32 sub_803029C(BattleObj *arg0, BattleObj *arg1)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 18:
            if (gUnk_03000825 <= 0x13)
            {
                arg0->posY = sub_801768C(gUnk_03000829, arg1->posY - gUnk_03000829, 0x14, gUnk_03000825, 2);
                gUnk_03000825 += 1;
                break;
            }
            arg0->posY = arg1->posY;
        ...
        case 20:
            if (arg0->headA.frameIdx <= 7)
                break;
            gUnk_0300086E = arg0->posX + 4;
            gUnk_0300086F = arg0->posY + 4;
            sub_8020CC4(arg0, gUnk_0300086E, gUnk_0300086F, 0x27C, 0xE, 0x332, 5);
        ...
        case 23:
            if (gUnk_03000825 <= 0x18)
            {
                if (gUnk_03000825 == 0xF)
                    sub_8044514(0x1E);
                arg0->headB.f_2B = sub_801768C(gUnk_0300086E, 0xFA - gUnk_0300086E, 0x19, gUnk_03000825, 2);
                gUnk_03000825 += 1;
            }
            else
            {
        ...
        case 24:
            ...
            {
                sub_801CE80(arg0, 0, gUnk_03000822, gUnk_03000824, 0);
                gUnk_03000820 = 0x19;
            }
        ...
        case 26:
            if (gUnk_03000825 <= 0x13)
            {
                arg0->posY = sub_801768C(arg1->posY, gUnk_03000829 - arg1->posY, 0x14, gUnk_03000825, 2);
                gUnk_03000825 += 1;
                break;
            }
            arg0->posY = gUnk_03000829;
            gUnk_03000820 = 9;
            break;
        case 9:
            if (gUnk_03000844 == 0 && gUnk_03000845 == 0 && gUnk_03000856 == 0)
...
// @ 0x08030664
/* 战斗对象"双头换装/形态切换"演出状态机 (gUnk_03000820: 0 起手 → 0x12..0x19 → 9)。
 ...
 * 推进, case23 把 headB.f_2B 从 gUnk_0300086E 向 0xFA 插值。
 *   case0   记 posX/posY/f_1E/palSlot, 计数=0, sub_80444A4 清同组伤害 + sub_803F5B4;
...
u8 sub_8030664(BattleObj *obj)
{
    ...
    switch (gUnk_03000820)
    {
        ...
        case 20:
            ...
            {
                gUnk_0300086E = obj->posX + 4;
                gUnk_0300086F = obj->posY + 4;
                sub_8020CC4(obj, gUnk_0300086E, gUnk_0300086F, 0x27C, 0xE, 0x334, 5);
                obj->headA.kindFlags |= 0x100;
                obj->headB.kindFlags |= 0x100;
                gUnk_03000820 = 0x15;
            }
        ...
        case 23:
            if (gUnk_03000825 <= 0x18)
            {
                if (gUnk_03000825 == 0xF)
                    sub_8044514(0x1E);
                obj->headB.f_2B = sub_801768C(gUnk_0300086E, 0xFA - gUnk_0300086E, 0x19, gUnk_03000825, 2);
                gUnk_03000825 += 1;
            }
            else
            {
